...
- Merged [pull request 222](https://github.com/yanyiwu/nodejieba/pull/222)
...
- 对 MP 算法的分词方式新增一个粒度参数，解决[issue29]关于细粒度分词的问题。
...
- 更新[cppjieba]，支持更低版本的 g++。

## v0.1.2

- 更新[cppjieba]，使用`less_memory`这个 branch 来减少 Trie 树内存的开销。

## v0.1.1

- 依照 node 的 c++扩展的常规写法，对 cppjieba 进行简单的包装，并已`npm publish`
